...
#MAKE MOMENT MAPS
#**********************
moments_data = datacube.make_moments(method='gaussian', parcube=True, writefits=False, tag='data_'+tag, writecomp=True)
moments_nopriors = datacube.make_moments(method='doublegaussian', kind='mask', lower2upper=0.5, tag='nopriors', parcube=True, writefits=False,  writecomp=True) #Do not use model priors
moments_gauss = datacube.make_moments(model=model, method='doublegaussian', kind='mask', parcube=True, writefits=False, writecomp=True) #Use model priors
moments_bell = datacube.make_moments(model=model, method='doublebell', kind='mask', parcube=True, writefits=False, writecomp=True) #Use model priors + bell kernel
